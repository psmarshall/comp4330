...
with Queues_Pack_Protected_Ordered_Generic;
with System;                                use System;

procedure Queues_Test_Priorities is
   ...
   package Avionics_Queue_Pack is
     new Queues_Pack_Protected_Ordered_Generic
       (Element => Sequence, Queue_Enum => Modules, Queue_Size => 2);
   ...
   begin
      ...
      begin
         for Order in Sequence loop
            ...
            Put_Line (Modules'Image (Module) & " removed " & Sequence'Image (Item) & " from queue.");
         end loop;
      end;
